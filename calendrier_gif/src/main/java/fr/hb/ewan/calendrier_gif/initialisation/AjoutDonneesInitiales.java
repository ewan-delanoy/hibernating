package fr.hb.ewan.calendrier_gif.initialisation;
...
import fr.hb.ewan.calendrier_gif.business.GifDistant;
...
import fr.hb.ewan.calendrier_gif.dao.EmotionDao;
import fr.hb.ewan.calendrier_gif.dao.GifDao;
import fr.hb.ewan.calendrier_gif.dao.JourDao;
import fr.hb.ewan.calendrier_gif.dao.ReactionDao;
import fr.hb.ewan.calendrier_gif.dao.ThemeDao;
import fr.hb.ewan.calendrier_gif.dao.UtilisateurDao;
import fr.hb.ewan.calendrier_gif.util.NbGifs;
	...
	public void ajouterUtilisateurs() {
		if (utilisateurDao.count() == 0) {
			...
			while (map.size() != 500) {
				...
				utilisateur.setMotDePasse(faker.internet().password(8, 12));
